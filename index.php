...
<html lang="en">
        ...
        <div class="row no-gutters slider-text justify-content-start align-items-center justify-content-center">
          <div class="col-lg-8 ftco-animate">
          	<div class="text w-100 text-center mb-md-5 pb-md-5">
	            <h1 class="mb-4">Enjoy your holidays with our wheels</h1>
	            <p style="font-size: 18px;">A Blue Lagoon is an agency that provides different types of automobiles on rent for a short period. It is primarily located near airport and main bus station.</p>
    		...
    		<div class="row no-gutters">
    			<div class="col-md-12	featured-top">
                    ...
                    <select class="form-control" id="pickuplist" name="take-location" >
                      ...
                      <option class="moja" value="3">Novi Beograd</option>
                    </select>
			    				</div>
			    				<div class="form-group">
                    ...
                    <select class="form-control" id="dropofflist" name="return-location">
                      ...
                      <option class="moja" value="3">Novi Beograd</option>
			                ...
			                <input type="text" class="form-control" id="book_pick_date" name="start-date" placeholder="Date" autocomplete="off" >
			              </div>
			              <div class="form-group ml-2">
			                <label for="" class="label">Drop-off date</label>
			                <input type="text" class="form-control" id="book_off_date" name="end-date" placeholder="Date" autocomplete="off" >
			              </div>
		              </div>
		              <div class="form-group">
    				...
    				<div class="carousel-car owl-carousel">
    					...
    					<div class="item">
    						<div class="car-wrap rounded ftco-animate">
		    					...
		    					<div class="text">
		    						<h2 class="mb-0"><a href="#"><?php echo $name;?></a></h2>
    ...
    <section class="ftco-section ftco-about">
			<div class="container">
	          ...
	          <div class="heading-section heading-section-white pl-md-5">
	            ...
	            <h2 class="mb-4">Welcome to Blue Lagoon</h2>

	            <p>Blue Lagun has a new face. After more than 5 years in business, we decided to give a fresher look to our brand and our services. With our fully renewed fleet of vehicles, we are ready to meet all expectations and requirements.</p>
    ...
    <section class="ftco-counter ftco-section img bg-light" id="section-counter">
    	...
    	<div class="container">
          ...
          <div class="col-md-6 col-lg-3 justify-content-center counter-wrap ftco-animate">
            <div class="block-18">
              <div class="text text-border d-flex align-items-center">
                <strong class="number" data-number="1190">0</strong>
  ...
  <script src="assets/car_match.js"></script>
  <script>
