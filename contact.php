        		...
        		<div class="row mb-5">
		          <div class="col-md-12">
		          	<div class="border w-100 p-4 rounded mb-2 d-flex">
			            ...
			            <p><span>Address:</span> Borcanskih Zrtava 26,11000 Belgrade</p>
			          </div>
		          </div>
		          <div class="col-md-12">
		          	<div class="border w-100 p-4 rounded mb-2 d-flex">
			            ...
			            <p><span>Phone:</span> <a href="tel://1234567920">+ 381 69 606 557</a></p>
			          </div>
		          </div>
		          <div class="col-md-12">
		          	<div class="border w-100 p-4 rounded mb-2 d-flex">
			            ...
			            <p><span>Email:</span> <a href="mailto:dekidjurdjev@gmail.com">dekidjurdjev@gmail.com</a></p>
			          </div>
		          </div>
		        </div>
          </div>
